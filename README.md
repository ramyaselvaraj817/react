...
### What happens when React renders a string versus a function?
...
### What is the key concept behind React's component design?
...
### How can you pass additional information to a React component?
...
### What is the difference between passing a string versus a function/component to React.createElement?
...
### In vanilla React (without JSX), what is one way to return multiple sibling elements from a component using React.createElement?
By passing them as array to the parent element.

### What happens when React.createElement receives a string as its first argument?
It outputs that string as DOM Node.

### How do you access properties passed to a React component created with React.createElement?
